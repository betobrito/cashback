...
Funcionalidade: Consultar Disco por Genero
    ...
    Cenario: 01 - Consultar Discos Por Genero com discos existentes
        Dado que o genero rock possua id "4" deveria retornar os "10" primeiros registros ordenados por "descricao"
        Entao deveria retornar dois discos:
            |  AC/DC 101                        |
            |  Enema Of The State - Blink 182   |

    Cenario: 02 - Consultar Disco Por Genero com discos inexistentes
        Dado que o genero rock possua id "5" deveria retornar os "10" primeiros registros ordenados por "descricao"
